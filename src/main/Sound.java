...
public class Sound {
	...
	public Sound() {
		...
		soundURL[11] = getClass().getResource("/sound/monster_shoot.wav");
		...
		soundURL[18] = getClass().getResource("/sound/speak-2.wav");
		soundURL[19] = getClass().getResource("/sound/break.wav");
		soundURL[20] = getClass().getResource("/sound/shovel_dirt.wav");
		soundURL[21] = getClass().getResource("/sound/flower_snap.wav");
		soundURL[22] = getClass().getResource("/sound/Dungeon.wav");
		soundURL[23] = getClass().getResource("/sound/Merchant.wav");
		soundURL[24] = getClass().getResource("/sound/dooropen.wav");
		soundURL[25] = getClass().getResource("/sound/chipwall.wav");
	}
