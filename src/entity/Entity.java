...
public class Entity {
	...
	public BufferedImage attackUp1, attackUp2, arrackUp2, attackDown1, attackDown2,
	attackLeft1, attackLeft2, attackRight1, attackRight2, guardUp, guardDown
	...
	public boolean transparenty = false;
	...
	public int life;
	public int maxMana; //how many projectiles
	public int mana;
	public int ammo;
	public int level;
	public int strength;
	...
	public final int type_shovel = 10;
	public final int type_maker = 11;
	public final int type_merchant = 12;
	public final int type_creator = 13;
	public final int type_pickaxe = 14;
...
//    		if(gp.npc[gp.currentMap][i].name.equals("name")) {
//    			npcIndex = i;
//    			break;
//    		}
//    	}
...
//	}
	...
	public void dropItem(Entity droppedItem) {
		...
		for(int i = 0; i < gp.obj[1].length; i++) {
			if(gp.obj[gp.currentMap][i] == null) {
				...
				gp.obj[gp.currentMap][i].worldX = worldX;// monster's world x/y
    ...
    public void checkShoot(int rate, int shotIntreval) {
    	int i = new Random().nextInt(rate);
		if (i == 0 && projectile.alive == false && shotAvailableCounter == shotIntreval) {
			gp.playSE(11);
	...
	public void attacking() {
		...
		if(spriteCounter > motion1_duration && spriteCounter <= motion2_duration) {
			...
			//adjust player's worldX/Y for the attackArea worldX/Y
			switch(direction) {
			...
			//check interactive tile destruction
	...
	public void damagePlayer(int attack) {
		...
		if(gp.player.invincible == false) {
			...
			if(gp.player.guarding == true && gp.player.direction.equals(canGuardDirection)) {
				...
				//normal guard
				damage /= gp.player.currentShield.defenseValue;
				gp.player.currentShield.life -= 1;
				if(gp.player.currentShield.life <= 0) {
					gp.player.inventory.remove(gp.player.getCurrentShieldSlot());
					gp.ui.drawShield();
	...
	public void changeAlpha(Graphics2D g2, float alphaV) {
		
		g2.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, alphaV ));
	...
	public void searchPath(int goalCol, int goalRow) {
		...
		if(gp.pFinder.search() == true) {
			...
			//disable if goal is player
			
			//stop search when goal is reached
